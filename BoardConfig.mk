...
DEVICE_PATH := device/realme/bearmonets
...
# Assert
TARGET_OTA_ASSERT_DEVICE := RMX1911,RMX1925,RMX1927,RMX2030,r5x,realme_trinket,bearmonets
...
# Init
TARGET_INIT_VENDOR_LIB := libinit_bearmonets
TARGET_RECOVERY_DEVICE_MODULES := libinit_bearmonets
...
TARGET_KERNEL_SOURCE := kernel/realme/bearmonets
...
BOARD_SUPER_PARTITION_GROUPS := bearmonets_dynpart
BOARD_BEARMONETS_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_BEARMONETS_DYNPART_PARTITION_LIST := odm product system system_ext vendor
...
-include vendor/realme/bearmonets/BoardConfigVendor.mk
